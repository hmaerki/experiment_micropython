# Pin assignements for PyBoard v3 - sanmuchina.com

The following output was produced using this example
https://github.com/micropython/micropython/blob/master/examples/pins.py

The file pins_af.py in this directory was copied from the buildfolder of the board.
...
Alternative pin assignements would be:
```
>>> pins.af()
